    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            addButton.addEventListener("click", function() {
                ...
                // Retrieve the selected "harga" based on the chosen "selected_barang"
                const selectedHarga = selectedBarang.options[selectedBarang.selectedIndex].getAttribute(
                    "data-harga");
                ...
                if (selectedBarangName && jumlahValue > 0) {
                    ...
                    // Create a dropdown for "harga" and set the selected value
                    const hargaDropdown = document.createElement("select");
                    hargaDropdown.name = "harga[]";
                    hargaDropdown.innerHTML = `<option value="${selectedHarga}">${selectedHarga}</option>`;
                    cell3.appendChild(hargaDropdown);
